...
Nota: Los puertos con propósitos personalizados se encuentran en desuso para esta aplicación. Sin embargo, deben incluirse en el diseño pues se contemplan en la programación del procesador. La exclusión de este bloque da error para el código en Vitis. Por otro lado, se incluyeron los bloques AXI para los botones y los leds para verificar la programación del procesador.
...
3. Clic en Create Application Proyect, en ventana de plataforma seleccionar Create a new platform from hardware (XSA) y en Browse agregar el. xsa.
...
-  Build en el martillo de la barra de herramientas
